                            ...
                            <div class="search-bars col-md-10">
                                <form class="search-forms d-flex align-items-center" method="POST" action="#"
                                    ...
                                    <input type="text" name="search" id="search"
                                        placeholder="Recherche d'un niveau"
                            ...
                            <tbody id="tbodys">
                                @foreach ($niveaux as $niveau)
                                    <tr id="sid{{ $niveau->id }}">
                                        ...
                                        <td><a href="{{ route('Admin.indexNiv', $niveau->id) }}" class="btn btn-success"><i class="fa fa-plus-circle"
                                            ...
                                            <a onclick="return confirm('Voulez vous supprimer se niveaux avec tout sont contenu?')" href="{{ route('Admin.niveau.delete', $niveau->id) }}"
...
@endsection
@section('scripts')
    <script src="{{ asset('js/admin/gestionNiveau.js') }}">
    </script>
@endsection
