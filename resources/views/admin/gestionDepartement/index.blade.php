...
@section('content')
    @include('layouts.admin.sidebarAdminGestionDepartementIndex')
    <main id="main" class="main">
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title text-center text-capitalize" style="font-size: 40px" >Gestions des departements</h1>
            ...
            <div class="card">
                ...
                @if ($departements->count() > 0)
                    <div class="card-body">
                        <br>
                        <div class="row">
                            <div class="col-lg-4"><a href="{{ route('Admin.departement.create') }}"> <i class="fa fa-plus"
                                        aria-hidden="true"></i> Ajouter un nouveau departement</a></div><br><br>
                            <div class="search-bars col-lg-8">
                            ...
                            <tbody id="tbodys">
                                @foreach ($departements as $departement)
                                    <tr id="sid{{ $departement->id }}">
                                        ...
                                        <td><a href="{{ route('Admin.indexDept', $departement->id) }}" class="btn btn-success"><i class="fa fa-plus-circle"
                                                    aria-hidden="true"></i> Voir plus</a>&ensp; &ensp;
                                            <a href="javascript:void(0)" onclick="editDepartement({{ $departement->id }})"
                                                class="btn btn-danger"><i class="fa fa-edit"
                                                    aria-hidden="true"></i>Update</a>&ensp; &ensp; 
                                            <a onclick="return confirm('Voulez vous supprimer se departement et avec tout sont contenu?')" href="{{ route('Admin.departement.delete', $departement->id) }}"
