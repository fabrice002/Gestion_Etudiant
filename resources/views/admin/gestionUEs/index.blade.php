                                ...
                                @foreach ($ues as $ue)
                                    <tr id="sid{{ $ue->id }}">
                                        ...
                                        <td><a href="{{ route('Admin.indexUE', $ue->id) }}" class="btn btn-success"><i
                                                ...
                                                Voir plus</a>&ensp;
                                            <a href="javascript:void(0)" onclick="editUe({{ $ue->id }})"
                                            ...
                                            <a onclick="return confirm('Voulez vous supprimer cette UE et avec tout sont contenu?')"
                                                href="{{ route('Admin.ue.delete', $ue->id) }}" class="btn btn-secondary"><i
                                                    class="fa fa-trash" aria-hidden="true"></i></i>Delete</a>
                                        </td>
